...
name varchar2(20) constraint twitter_login_name_nn not null
);

insert into twitter_login
values('hyun', '6789', '김동현');
...
values (twitter_seq.nextval, 'hyun', '첫 번째 트윗입니다...^^ 잘 보이시나요?');

insert into twitter (no, id, message)
values (twitter_seq.nextval, 'gdhong', 'en 번째 트윗입니다...^^ 잘 실행되시나요?');
